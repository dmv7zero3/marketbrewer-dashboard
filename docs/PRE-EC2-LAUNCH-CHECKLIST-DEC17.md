...
- [packages/server/__tests__/e2e.test.ts](packages/server/__tests__/e2e.test.ts)
...
**Review Files:**
- [packages/server/__tests__/e2e.test.ts](packages/server/__tests__/e2e.test.ts)
- [packages/shared/__tests__/](packages/shared/__tests__/)
- [packages/worker/src/__tests__/](packages/worker/src/__tests__/)
...
- [ ] **GO WITH CAVEATS** (document known risks)
