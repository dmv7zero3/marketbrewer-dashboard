...
How workers claim jobs, handle concurrency, and manage failures.
...
| Claim timeout | 5 minutes | Max time before auto-release |
...
| 4+ | — | Mark failed, require manual retry |
  ...
  "workers": [
    {
      "id": "macbook-pro-1",
      "status": "active",
      "lastHeartbeat": "2025-12-16T10:30:00Z",
...
## Spot Interruption (EC2)

For optional EC2 GPU workers:
